...
import { ArrowLeft, Plus, BookOpen, Calendar, Edit3, Trash2, X, Check } from 'lucide-react';
              ...
              <Card variant="glass">
                <CardContent className="p-6">
                  ...
                  <Textarea
                    ...
                    className="min-h-[200px] rounded-xl resize-none border-border/50 mb-4"
                    autoFocus
                  />
              ...
              {journalEntries.length === 0 ? (
                <Card variant="gradient" className="text-center py-12">
                  <CardContent>
                    ...
                    <h3 className="font-semibold text-foreground mb-2">Start Your Journal</h3>
